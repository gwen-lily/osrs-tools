...
from osrs_tools.character import Player, OlmMeleeHand
...
def one_torva_options():
    ...
    _, table = bedevere_2d(lad, target, equipment=switches, boosts=boosts, prayers=prayers, data_mode=DataMode.MAX_HIT, floatfmt='.0f')
    print(table)
...
def one_torva_options():
    ...
    (data_axes, indicies, data_ary), table = bedevere_2d(lad, target,
                                                         equipment=switches,
                                                         boosts=boosts,
                                                         prayers=prayers,

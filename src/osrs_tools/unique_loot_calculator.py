...
def ori_maths():
	...
	dps_alt_points = (team_points - capped_acc_points) * fraction_of_leftover_points_on_dps_alts
	sigma = sum_of_individual_points = capped_acc_points + dps_alt_points
	...
	print(f'chance of a capped account getting a purple: {p_loot_on_capped_acc * 100:.1f}%')
	print(f'chance of seeing at least one purple: {chance_to_see_any_amount_of_drops*100:.0f}%')
